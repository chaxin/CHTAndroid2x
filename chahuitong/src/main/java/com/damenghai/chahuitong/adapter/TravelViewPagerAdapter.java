...
public class TravelViewPagerAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(ViewGroup container, final int position) {
        ...
        utils.configDefaultLoadingImage(R.drawable.default_load_image);
        utils.configDefaultLoadFailedImage(R.drawable.default_load_image);
        utils.display(image, travel.getThumbImage());
