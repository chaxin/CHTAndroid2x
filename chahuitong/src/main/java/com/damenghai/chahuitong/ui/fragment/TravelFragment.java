 ...
 */
public class TravelFragment extends BaseFragment implements OnRefreshListener, OnLastItemVisibleListener {
    private View mView;
    ...
    private class ListViewAdapter extends CommonAdapter<Travel> {
