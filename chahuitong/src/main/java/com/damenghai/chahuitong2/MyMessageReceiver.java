...
import com.damenghai.chahuitong2.ui.activity.MessageActivity;
import com.damenghai.chahuitong2.utils.CollectionUtils;
 ...
 * @Description: Bmob消息推送接收器,来自Bmob官方Demo
 * @author smile
...
public class MyMessageReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		...
		boolean isNetConnected = NetworkUtils.isConnected(context);
		if(isNetConnected){
