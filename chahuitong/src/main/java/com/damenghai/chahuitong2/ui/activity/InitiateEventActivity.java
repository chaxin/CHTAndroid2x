...
public class InitiateEventActivity extends BaseActivity implements View.OnClickListener, AdapterView.OnItemClickListener {
    ...
    public void onClick(View view) {
        ...
        mProgressDialog = new ProgressDialog(InitiateEventActivity.this);
    ...
    public void commit() {
        ...
        EventAPI.initiateEvent(this, mTravel, new VolleyRequest(mProgressDialog) {
            @Override
