...
import com.damenghai.chahuitong2.response.StringListener;
...
public class ProfileActivity extends BaseActivity implements OnClickListener {
    ...
    private void loadData() {
        AccountApi.showProfile(ProfileActivity.this, new StringListener(ProfileActivity.this) {
            @Override
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if(requestCode == ImageUtils.GALLERY_REQUEST_CODE) {
            ...
            if(resultCode == Activity.RESULT_CANCELED || ImageUtils.imageUri == null) return;
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.profile_commit :
                AccountApi.updateProfile(ProfileActivity.this, mLeader, new StringListener(ProfileActivity.this) {
                    @Override
                    public void onSuccess(String response) {
