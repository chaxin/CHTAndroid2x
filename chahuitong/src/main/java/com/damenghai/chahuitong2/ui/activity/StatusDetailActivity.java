...
import com.damenghai.chahuitong2.adapter.GridViewImagesAdapter;
import com.damenghai.chahuitong2.adapter.StatusCommentAdapter;
...
public class StatusDetailActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void setImage() {
        ...
        if(picUrls != null && picUrls.size() > 1) {
            ...
            bitmapUtils.display(iv_image, picUrls.get(0).getBmiddle_pic(), ImageConfigHelper.getGrayConfig(StatusDetailActivity.this));
